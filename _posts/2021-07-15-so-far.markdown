...
<br>
After Atlas, I moved to a team called Lambda. Lambda team was coming up with an Actor system to make stream processing on top of events easier for developers. The stack comprises of a Rails-like framework written in Clojure and a Heroku-like platform written in Ruby. I got an opportunity to soon lead this fantastic team of developers for the first time in my career. 
